...
public class DrugManager {
    ...
    public Workbook getTemplet() {
        ...
        for(int index =0; index < unitItmList.size(); index++){
            if(StringUtils.isEmpty(unitItmList.get(index).getDicItemName())) continue;
        ...
        for(int index =0; index < drugFormList.size(); index++){
            if(StringUtils.isEmpty(drugFormList.get(index).getDicItemName())) continue;
        ...
        for(int index =0; index < categoryList.size(); index++){
            if(StringUtils.isEmpty(categoryList.get(index).getDicItemName())) continue;
        ...
        for(int index =0; index < useageList.size(); index++){
            if(StringUtils.isEmpty(useageList.get(index).getDicItemName())) continue;
        ...
        for(int index =0; index < frequencyList.size(); index++){
            if(StringUtils.isEmpty(frequencyList.get(index).getDicItemName())) continue;
